...
var Tweetbar = {
	...
	expand_status:
		function (s) {
			...
			ret = ret.replace(re, '<a rel="twitpic_gm" href="tkavoidurl://twitpic.com/$1"><img style="border: 1px solid #ccc; float: left; margin: 0 3px 3px 0; height: 72px; width: 72px;" src="tkavoidurl://twitpic.com/$1-thumb" border="0" /></a>$2');
