...
var Tweetbar = {
	...
	expand_status:
		function (s) {
			return s.toString().replace(/\</,'&lt;').replace(/((?:ftp|https?):\/\/\S+)/g, this.anchor_tag('$1')).replace(/\@([0-9a-z_A-Z]+)/g, this.anchor_tag(Tweetbar.protocol + ':\/\/twitter.com/$1'.toLowerCase(),'@$1','$1 ' + this._('misc.onTwitter')));
		},
	/**
